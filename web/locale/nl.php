...
$l["nl"] = array(
    ...
    "nomp3" =>      "Je moet akkoord gaan met de MP3 voorwaarden voordat je een MP3 conversie begint.",
    "nowav" =>      "Je moet akkoord gaan met de wav voorwaarden voordat je een wav conversie begint.",

    "downloading" =>"Downloaden..",
    "downfail" =>   "Downloaden mislukt!",
    "notracks" =>   "Geen sporen gevonden!",
    "complete" =>   "Alles is verwerkt!",
    ...
    "delete1" =>    "Dit zal de opname VERWIJDEREN ",
    "delete2" =>    "! Weet je het zeker?",
