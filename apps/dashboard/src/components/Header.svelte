...
<header class="absolute left-0 right-0 z-[1] mx-auto flex w-full max-w-4xl items-center justify-between p-2 sm:p-6">
  <div class="font-display flex items-center justify-center gap-1 text-xl text-white sm:gap-2 sm:text-3xl">
    <a class="group flex items-center justify-center gap-2 sm:gap-3" href="https://craig.chat" target="_blank">
      ...
      />
      <div class="font-bold underline decoration-transparent transition-colors group-hover:decoration-teal-500">Craig</div>
    </a>
    <span>Dashboard</span>
  </div>
