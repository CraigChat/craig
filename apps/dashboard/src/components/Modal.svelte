...
<Portal target="body">
  ...
  >
    <div
      ...
      class={cn(
        'relative inline-flex max-h-[calc(100svh-6rem)] w-5xl flex-col items-start justify-start overflow-hidden rounded-t-lg bg-zinc-900 text-zinc-300 shadow-lg ring-2 ring-black/50 md:rounded-b-lg',
        wrapperClass
      )}
    >
      {@render children?.()}
