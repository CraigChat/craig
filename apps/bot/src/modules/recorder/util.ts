...
const VAD_HEADER = Buffer.from([0x45, 0x43, 0x56, 0x41, 0x44, 0x44, 0x03, 0x00, 0x00, 0x03, 0x01]);
...
export const OPUS_HEADERS_MONO = [
  ...
  Buffer.from([
    0x4f, 0x70, 0x75, 0x73, 0x54, 0x61, 0x67, 0x73, 0x0a, 0x00, 0x00, 0x00, 0x65, 0x6e, 0x6e, 0x75, 0x69, 0x63, 0x61, 0x73, 0x74, 0x72, 0x00, 0x00,
    0x00, 0x00
  ])
];
